...
class SearchAdapter(private val context: Context, private val itemMap: HashMap<Restaurants,MutableList<Item>> )
    ...
    class SearchViewHolder (val binding: CardSearchItemBinding): RecyclerView.ViewHolder(binding.root){
    }
    ...
    override fun onBindViewHolder(holder: SearchViewHolder, position: Int) {
        ...
        holder.binding.searchRecyclerview.layoutManager = StaggeredGridLayoutManager(1,RecyclerView.HORIZONTAL)
